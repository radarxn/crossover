...
public class PanelController {
  ...
  public ResponseEntity<?> saveHourlyElectricity(
	  ...
	  Panel thisPanel = panelService.findBySerial(panelSerial);
	  hourlyElectricity.setPanel(thisPanel);
  ...
  public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
      @PathVariable(value = "panel-serial") String panelSerial) {
    Panel panel = panelService.findBySerial(panelSerial);
    List<DailyElectricity> dailyElectricityForPanel = dailyElectricityService.getAllDailyElectricityByPanelId(panel.getId());
    if (dailyElectricityForPanel == null) {
    	dailyElectricityForPanel = new ArrayList<DailyElectricity>();
    }
    /**
